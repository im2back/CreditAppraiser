...
public class ClientController {
	...
	@ApiResponses({
		@ApiResponse(responseCode = "201", description = "Retorna um DTO de Client em caso de sucesso"),
	...
	@Operation
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "Retorna um DTO de Client aparit de um CPF"),
